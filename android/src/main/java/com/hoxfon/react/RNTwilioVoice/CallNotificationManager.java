                                               ...
                                               Intent launchIntent)
    {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(context, VOICE_CHANNEL)
                        ...
                        .setContentText(callInvite.getFrom().substring(7, id.length()).split("_", -1)[0] + " is calling")
                        .setOngoing(true)
                        .setAutoCancel(true)
                        .setExtras(extras)
    ...
    public void createMissedCallNotification(ReactApplicationContext context, CallInvite callInvite) {
        ...
        NotificationCompat.Builder notification =
                new NotificationCompat.Builder(context, VOICE_CHANNEL)
                        ...
                        .setContentText(callInvite.getFrom().substring(7, id.length()).split("_", -1)[0] + " called")
                        .setAutoCancel(true)
                        .setShowWhen(true)
                        .setExtras(extras)
        ...
        inboxStyle.addLine("from: " +callInvite.getFrom().substring(7, id.length()).split("_", -1)[0]);
